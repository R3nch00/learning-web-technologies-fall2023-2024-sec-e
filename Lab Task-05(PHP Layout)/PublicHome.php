<html>
    <head>
        <title>Home page of X-company</title>
    </head>
    <body>
        ...
        <tr>
            <td style="padding-bottom: 100;"><h2 style="margin: 30;">Welcome to the xCompany</h2></td>
        </tr>

        <tr align="center">
            <td>
                <footer style="margin: 10;">Copytight &copy; 2017</footer>
            </td>
        </tr>
